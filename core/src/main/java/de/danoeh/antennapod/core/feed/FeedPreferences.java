...
public class FeedPreferences {
    ...
    private FeedPreferences(long feedID, boolean autoDownload, boolean keepUpdated, PlayedAction played_action, String username, String password, @NonNull FeedFilter filter) {
        this.feedID = feedID;
